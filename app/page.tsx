...
const services = [
  {
    title: "Creatieve invalshoeken",
    body: "We schrijven creatieve teksten die klanten trekken, zodat u zich kunt focussen op uw klant.",
    icon: "✦",
  },
  {
    title: "Laat uw stem horen!",
    body: "Authenticiteit is prioriteit! Alles wordt eerst door u goedgekeurd. Zo houdt u eigen stijl en stem.",
    icon: "◆",
  },
  {
    title: "Blijf bij de tijd",
    body: "Een frisse blik op uw website of publicatie, met tips en tricks om uw publiek te bereiken.",
    icon: "❋",
  },
];
    ...
    <>
        ...
        <div className="max-w-6xl mx-auto px-6 py-24 grid md:grid-cols-2 gap-16 items-center">
          <div className="space-y-8">
            ...
            <p className="text-lg text-[var(--color-on-surface-variant)] leading-relaxed max-w-md">
              Tekstbureau Tulp schrijft pakkende teksten die klanten trekken — met authenticiteit als prioriteit.
            </p>
          ...
          <div className="relative hidden md:block">
            ...
            <div className="absolute -bottom-6 -left-6 bg-[var(--color-surface-container-lowest)] rounded-[var(--radius-brand)] px-6 py-4 shadow-[0_20px_40px_rgba(0,32,30,0.08)]">
              ...
              <p className="text-xs font-[var(--font-label)] uppercase tracking-widest text-[var(--color-on-surface-variant)] mt-0.5">
                Jaren ervaring
              </p>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-14 space-y-3">
            ...
            <h2 className="font-[var(--font-headline)] text-4xl font-bold italic text-[var(--color-on-surface)]">
              De kunst van messcherpe teksten
            </h2>
          </div>
          <div className="grid md:grid-cols-3 gap-6">
            {services.map(({ title, body, icon }) => (
              <div
                key={title}
                className="bg-[var(--color-surface-container-lowest)] rounded-[var(--radius-brand)] p-8 space-y-4 shadow-[0_4px_24px_rgba(0,32,30,0.04)]"
              >
                <span className="text-3xl text-[var(--color-primary)]">{icon}</span>
                <h3 className="font-[var(--font-headline)] text-xl font-bold text-[var(--color-on-surface)] italic">
                  {title}
                </h3>
        ...
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
          <div className="space-y-6">
            ...
            <h2 className="font-[var(--font-headline)] text-4xl font-bold italic text-[var(--color-on-surface)] leading-tight">
              Tekstbureau Tulp denkt altijd in mogelijkheden.
            </h2>
            <p className="text-[var(--color-on-surface-variant)] leading-relaxed">
              Van een korte redactiesessie tot een volledige contentstrategie — ik pas mijn aanpak aan op uw wensen en doelgroep.
            </p>
            <Link
              href="/diensten"
              className="inline-flex items-center text-[var(--color-primary)] text-xs font-bold uppercase tracking-widest font-[var(--font-label)] border-b-2 border-[var(--color-primary-fixed)] pb-0.5 hover:border-[var(--color-primary)] transition-colors"
            >
      ...
      <section className="bg-[var(--color-primary)] py-24">
        <div className="max-w-6xl mx-auto px-6 text-center space-y-6">
          <p className="font-[var(--font-label)] text-xs font-bold uppercase tracking-[0.3em] text-[var(--color-primary-fixed)]">
            Gratis aangeboden
          </p>
          <h2 className="font-[var(--font-headline)] text-4xl md:text-5xl font-bold italic text-[var(--color-on-primary)] leading-tight">
            Klaar voor een frisse blik op uw website?
          </h2>
          <p className="text-[var(--color-on-primary)]/80 max-w-xl mx-auto leading-relaxed">
            De quickscan kijkt naar leesbaarheid, doelgroep, online vindbaarheid en kansen. Volledig gratis en vrijblijvend.
          </p>
          <Link
            href="/contact"
            className="inline-flex items-center bg-[var(--color-on-primary)] text-[var(--color-primary)] text-xs font-bold uppercase tracking-widest px-8 py-4 rounded-[var(--radius-brand)] hover:bg-[var(--color-primary-fixed)] transition-colors font-[var(--font-label)]"
          >
